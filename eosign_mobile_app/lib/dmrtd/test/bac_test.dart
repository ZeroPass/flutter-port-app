...
void main() {
  test('BAC key seed test', () {
    ...
    expect( BACKeySeed.fromMRZ(mrz).keySeed() , "b366ad857ddca2b08c0e299811714730".parseHex()         );
    ...
    expect( BACKeySeed.fromMRZ(mrz).keySeed() , "239AB9CB282DAF66231DC5A4DF6BFBAE".parseHex()         );
  });
}